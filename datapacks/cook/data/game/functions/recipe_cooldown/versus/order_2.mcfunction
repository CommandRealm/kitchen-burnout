...
tag @e[type=#game:ingredient_box_outline,tag=ingredient_box_outline,distance=..500] remove recipe_ingredient
team join no_collision @e[type=#game:ingredient_box_outline,tag=ingredient_box_outline,distance=..500]
