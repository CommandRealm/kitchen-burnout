...
execute if entity @s[tag=!team_2] run function game:recipe_cooldown/versus/ingredients_1
execute if entity @s[tag=team_2] run function game:recipe_cooldown/versus/ingredients_2
