...
execute as @a[gamemode=adventure,tag=playing,scores={recipe_cooldown=0}] at @s run tag @e[type=marker,tag=prep_display,sort=nearest,limit=1,distance=..500] add place_plate
