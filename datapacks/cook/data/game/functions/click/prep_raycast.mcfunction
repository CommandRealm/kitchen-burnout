# Raycast
execute as @e[type=marker,distance=..1,limit=1,sort=nearest,tag=prep_display] unless entity @e[type=armor_stand,tag=compact_display,distance=..10] run scoreboard players set @s prep_display 1
