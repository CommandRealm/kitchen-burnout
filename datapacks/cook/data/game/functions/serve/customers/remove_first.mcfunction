...
kill @e[type=#game:customer,tag=customer,tag=kill_customer]
kill @e[type=#game:customer,tag=customer,tag=kill_customer]
tag @e[type=magma_cube,tag=customer,tag=!kill_customer,sort=nearest,limit=1,distance=..100] add update_line_first
tag @e[type=villager,tag=customer,tag=!kill_customer,sort=nearest,limit=1,distance=..100] add update_line_first
tag @e[type=magma_cube,tag=customer,tag=update_line_first,tag=!kill_customer,sort=nearest,limit=1,distance=..100] add update_line_pos
