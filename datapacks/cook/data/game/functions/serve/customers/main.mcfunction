...
execute if score @s customers matches ..2 unless entity @e[type=villager,tag=customer,tag=update_line_pos,distance=..100] unless score $competitive customers matches 3.. run function game:serve/customers/summon
# Move customers
