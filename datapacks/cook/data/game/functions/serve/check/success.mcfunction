...
execute unless entity @s[tag=tutorial] if score $mode settings matches 2 unless score $food_type_1 shuffle matches 4.. unless score $recipes_1 shuffle >= $recipes settings unless entity @s[tag=2] run scoreboard players set @a[gamemode=adventure,tag=playing,tag=!tutorial,limit=1,tag=!team_2] recipe_cooldown 25
execute unless entity @s[tag=tutorial] if score $mode settings matches 2 unless score $food_type_2 shuffle matches 4.. unless score $recipes_2 shuffle >= $recipes settings if entity @s[tag=2] run scoreboard players set @a[gamemode=adventure,tag=playing,tag=!tutorial,limit=1,tag=team_2] recipe_cooldown 25
scoreboard players operation $recipes_minus_1 shuffle = $recipes settings
scoreboard players operation $recipes_minus_1 shuffle -= $1 number
execute unless entity @s[tag=tutorial] if score $mode settings matches 2 if score $food_type_1 shuffle matches 4 unless score $recipes_1 shuffle >= $recipes_minus_1 shuffle unless entity @s[tag=2] run scoreboard players set @a[gamemode=adventure,tag=playing,tag=!tutorial,limit=1,tag=!team_2] recipe_cooldown 25
execute unless entity @s[tag=tutorial] if score $mode settings matches 2 if score $food_type_2 shuffle matches 4 unless score $recipes_2 shuffle >= $recipes_minus_1 shuffle if entity @s[tag=2] run scoreboard players set @a[gamemode=adventure,tag=playing,tag=!tutorial,limit=1,tag=team_2] recipe_cooldown 25