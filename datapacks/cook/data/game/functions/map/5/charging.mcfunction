...
execute if score @s tnt_launchpad matches 51..60 run title @s title ["",{"text":"|||||","color":"red","bold":true},{"text":"||||||||||","color":"gray","bold":true}]
execute if score @s tnt_launchpad matches 61..70 run title @s title ["",{"text":"||||||","color":"red","bold":true},{"text":"|||||||||","color":"gray","bold":true}]
execute if score @s tnt_launchpad matches 71..80 run title @s title ["",{"text":"|||||||","color":"red","bold":true},{"text":"||||||||","color":"gray","bold":true}]
execute if score @s tnt_launchpad matches 81..90 run title @s title ["",{"text":"||||||||","color":"red","bold":true},{"text":"|||||||","color":"gray","bold":true}]
execute if score @s tnt_launchpad matches 91..100 run title @s title ["",{"text":"|||||||||","color":"red","bold":true},{"text":"||||||","color":"gray","bold":true}]
execute if score @s tnt_launchpad matches 101..110 run title @s title ["",{"text":"||||||||||","color":"red","bold":true},{"text":"|||||","color":"gray","bold":true}]
execute if score @s tnt_launchpad matches 111..120 run title @s title ["",{"text":"|||||||||||","color":"red","bold":true},{"text":"||||","color":"gray","bold":true}]
execute if score @s tnt_launchpad matches 121..130 run title @s title ["",{"text":"||||||||||||","color":"red","bold":true},{"text":"|||","color":"gray","bold":true}]
execute if score @s tnt_launchpad matches 131..140 run title @s title ["",{"text":"|||||||||||||","color":"red","bold":true},{"text":"||","color":"gray","bold":true}]
execute if score @s tnt_launchpad matches 141..150 run title @s title ["",{"text":"||||||||||||||","color":"red","bold":true},{"text":"|","color":"gray","bold":true}]
execute if score @s tnt_launchpad matches 151..160 run title @s title ["",{"text":"|||||||||||||||","color":"red","bold":true}]
# Effects
...
# Max charge
execute if score @s tnt_launchpad matches 151.. if score $flashing game_ticks matches ..3 run title @s title ["",{"text":"|||||||||||||||","color":"gray","bold":true}]
...
execute if score @s tnt_launchpad matches 151.. if score $flashing game_ticks matches 4..8 run title @s title ["",{"text":"|||||||||||||||","color":"red","bold":true}]
