...
execute if score @s tnt_launchpad matches 20.. positioned ~ ~1 ~ run summon creeper ^ ^ ^-1 {Fuse:0,Invulnerable:1b,Tags:["die_between_games"]}
execute if score @s tnt_launchpad matches 40.. positioned ~ ~1 ~ run summon creeper ^ ^ ^-1 {Fuse:0,Invulnerable:1b,Tags:["die_between_games"]}
execute if score @s tnt_launchpad matches 60.. positioned ~ ~1 ~ run summon creeper ^ ^ ^-1 {Fuse:0,Invulnerable:1b,Tags:["die_between_games"]}
execute if score @s tnt_launchpad matches 80.. positioned ~ ~1 ~ run summon creeper ^ ^ ^-1 {Fuse:0,Invulnerable:1b,Tags:["die_between_games"]}
execute if score @s tnt_launchpad matches 100.. positioned ~ ~1 ~ run summon creeper ^ ^ ^-1 {Fuse:0,Invulnerable:1b,Tags:["die_between_games"]}
execute if score @s tnt_launchpad matches 120.. positioned ~ ~1 ~ run summon creeper ^ ^ ^-1 {Fuse:0,Invulnerable:1b,Tags:["die_between_games"]}
execute if score @s tnt_launchpad matches 140.. positioned ~ ~1 ~ run summon creeper ^ ^ ^-1 {Fuse:0,Invulnerable:1b,Tags:["die_between_games"]}
execute if score @s tnt_launchpad matches 160.. positioned ~ ~1 ~ run summon creeper ^ ^ ^-1 {Fuse:0,Invulnerable:1b,Tags:["die_between_games"]}
