...
tp @a[tag=playing,tag=!tutorial,tag=!team_2,scores={map=9}] 1501 67 1497 180 5
spawnpoint @a[tag=playing,tag=!tutorial,tag=!team_2,scores={map=9}] 1501 67 1497 180
