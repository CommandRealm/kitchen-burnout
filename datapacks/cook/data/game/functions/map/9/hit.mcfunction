...
execute as @e[type=glow_item_frame,tag=ingredient_box_outline,tag=bun,distance=..2] run scoreboard players set @a[gamemode=adventure,tag=playing,scores={map=9},distance=..500,tag=archery_owner,sort=nearest,limit=1] ingredient 1
