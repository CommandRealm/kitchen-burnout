...
tp @a[tag=playing,tag=!tutorial,tag=team_2,scores={map=15}] 12160 88 1988 180 -5
spawnpoint @a[tag=playing,tag=!tutorial,tag=team_2,scores={map=15}] 12160 88 1988 180
