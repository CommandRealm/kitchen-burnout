# Give ingredient
execute if entity @s[tag=hamburger_bun] run scoreboard players set @a[gamemode=adventure,tag=playing,scores={map=17,ingredient=0},distance=..1.5,limit=1,sort=nearest] ingredient 1
