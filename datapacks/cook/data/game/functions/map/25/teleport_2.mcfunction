# Taco Factory map
tp @a[tag=playing,tag=!tutorial,tag=team_2,scores={map=25}] 12963 70 1996 -90 5
spawnpoint @a[tag=playing,tag=!tutorial,tag=team_2,scores={map=25}] 12963 70 1996 -90
