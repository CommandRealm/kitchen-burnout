...
execute if score @s[tag=ceiling_laser_outer] laser_pos matches ..29 run tag @s add active_laser
execute if score @s[tag=ceiling_laser_inner] laser_pos matches ..29 run tag @s remove active_laser
execute if score @s[tag=ceiling_laser_outer] laser_pos matches 30.. run tag @s remove active_laser
execute if score @s[tag=ceiling_laser_inner] laser_pos matches 30.. run tag @s add active_laser
execute if score @s laser_pos matches 59.. run scoreboard players reset @s laser_pos
...
execute if entity @s[tag=active_laser] if score @s laser_pos matches 30 run playsound block.beacon.deactivate master @a ~ 66.10 ~ 0.4 0
