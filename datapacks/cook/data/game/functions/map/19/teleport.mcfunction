...
tp @a[tag=playing,tag=!tutorial,tag=!team_2,scores={map=19}] 2537 102 1500 90 -15
spawnpoint @a[tag=playing,tag=!tutorial,tag=!team_2,scores={map=19}] 2537 103 1500 90
