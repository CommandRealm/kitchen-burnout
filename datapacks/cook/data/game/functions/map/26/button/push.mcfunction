...
execute store result entity @e[type=armor_stand,tag=ice_bridge,tag=temporary_tag,distance=..5,limit=1,sort=nearest] Motion[0] double 0.6 run scoreboard players operation @e[type=armor_stand,tag=ice_bridge,tag=temporary_tag,distance=..5,limit=1,sort=nearest] ice_bridge -= @s ice_bridge
# Z Motion
...
execute store result entity @e[type=armor_stand,tag=ice_bridge,tag=temporary_tag,distance=..5,limit=1,sort=nearest] Motion[2] double 0.6 run scoreboard players operation @e[type=armor_stand,tag=ice_bridge,tag=temporary_tag,distance=..5,limit=1,sort=nearest] ice_bridge -= @s ice_bridge
# Remove tag
