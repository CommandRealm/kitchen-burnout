...
# Lock
execute if score @s in_pipe_time matches ..43 run tp @s 11962 -58 1507
...
title @s title ""
# Leave Pipe
execute if score @s in_pipe_time matches 44 run tp @s 11972.71 61 1494.0
execute if score @s in_pipe_time matches 45.. run function game:map/14/leave_pipe_2