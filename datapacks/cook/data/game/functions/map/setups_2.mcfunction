...
execute if entity @a[gamemode=adventure,tag=playing,scores={map=8},tag=team_2] run function game:map/8/setup_2
execute if entity @a[gamemode=adventure,tag=playing,scores={map=13},tag=team_2] run function game:map/13/setup_2
execute if entity @a[gamemode=adventure,tag=playing,scores={map=14},tag=team_2] run function game:map/14/setup_2
execute if entity @a[gamemode=adventure,tag=playing,scores={map=17},tag=team_2] run function game:map/17/setup_2
...
execute if entity @a[gamemode=adventure,tag=playing,scores={map=28},tag=team_2] run function game:map/28/setup_2