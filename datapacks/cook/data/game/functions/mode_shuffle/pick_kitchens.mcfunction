...
execute if score $output random matches 1 run scoreboard players set $tacos_map shuffle 22
execute if score $output random matches 2 run scoreboard players set $tacos_map shuffle 25
