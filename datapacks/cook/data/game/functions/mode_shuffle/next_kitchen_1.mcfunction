...
execute unless score $food_type_1 shuffle matches 5.. run scoreboard players set $recipes_1 shuffle 0
...
execute unless score $food_type_1 shuffle matches 5.. as @e[type=#game:reset_boxes,tag=reset_boxes,tag=!tutorial,distance=..500] at @s run function game:map/reset_boxes
