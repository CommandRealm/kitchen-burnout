...
execute unless score $food_type_2 shuffle matches 5.. run scoreboard players set $recipes_2 shuffle 0
...
execute unless score $food_type_2 shuffle matches 5.. as @e[type=#game:reset_boxes,tag=reset_boxes,tag=!tutorial,distance=..500] at @s run function game:map/reset_boxes
...
execute unless score $food_type_2 shuffle matches 5.. run tp @e[tag=die_between_games,tag=die_2] 0 -10000 0
