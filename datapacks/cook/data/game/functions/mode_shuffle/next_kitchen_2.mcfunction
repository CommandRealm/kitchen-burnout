...
# Announce
execute unless score $food_type_2 shuffle matches 5.. run tellraw @a ["",{"text":"\u2010 ","color":"gold","bold":true},{"translate":"The Diners are in kitchen ","color":"gray"},{"score":{"name":"$food_type_2","objective":"shuffle"},"color":"red","bold":false},{"text":"/4","color":"red","bold":false}]
...
execute unless score $food_type_2 shuffle matches 5.. as @e[type=marker,tag=ingredient_box,distance=..500] at @s run function game:map/reset_boxes
execute unless score $food_type_2 shuffle matches 5.. as @e[type=marker,tag=fish_spawner,distance=..500] at @s run function game:map/reset_boxes
execute unless score $food_type_2 shuffle matches 5.. as @e[type=marker,tag=customer_line,distance=..500] at @s run function game:map/reset_boxes
