...
execute if score $rand random matches 3 run data modify storage orders1 Recipe append from storage recipe:bank Recipe[3]
execute if score $rand random matches 4 run data modify storage orders1 Recipe append from storage recipe:bank Recipe[4]
execute if score $rand random matches 5 run data modify storage orders1 Recipe append from storage recipe:bank Recipe[5]
execute if score $rand random matches 6 run data modify storage orders1 Recipe append from storage recipe:bank Recipe[6]
execute if score $rand random matches 7 run data modify storage orders1 Recipe append from storage recipe:bank Recipe[7]
execute if score $rand random matches 8 run data modify storage orders1 Recipe append from storage recipe:bank Recipe[8]
