...
scoreboard players set $new_box ingredient 45
data modify storage game:new_ingredient_box ingredient set value "mint"
setblock 0 -60 0 chest
loot replace block 0 -60 0 container.0 loot game:food/ice_cream/mint
