...
setblock ~ ~ ~ water
#summon magma_cube ~ ~ ~ {Silent:1b,Invulnerable:1b,NoAI:1b,Size:2,Tags:["die_between_games","fish_spawner_pusher"],ActiveEffects:[{Id:14b,Amplifier:1b,Duration:1000000,ShowParticles:0b}]}