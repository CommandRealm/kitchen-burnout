...
execute if score @s prep_display matches -1 as @e[type=armor_stand,tag=prep_slot,tag=final_position] at @s run function game:stations/prep/tp/compact_close
