...
execute as @s[tag=base_ingredient] at @s if entity @e[type=armor_stand,tag=compact_display,tag=base_ingredient,distance=..0.0275,tag=!temporary_tag] run tp @s ~ ~0.033 ~
