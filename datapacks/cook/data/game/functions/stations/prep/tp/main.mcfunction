...
execute as @s[tag=base_ingredient] at @s if entity @e[type=armor_stand,tag=prep_slot,tag=base_ingredient,distance=..0.08,tag=!temporary_tag] positioned ~ ~ ~ run tp @s ~ ~0.09 ~
