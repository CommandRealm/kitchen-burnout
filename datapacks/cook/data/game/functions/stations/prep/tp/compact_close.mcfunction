...
execute as @s[tag=primary_ingredient,tag=!base_ingredient,tag=final_position] at @s positioned ~-0.3125 ~0.77 ~-0.375 unless entity @e[type=marker,tag=prep_display,distance=..0.04] positioned ~0.3125 ~-0.77 ~0.375 unless entity @e[type=armor_stand,tag=prep_slot,tag=primary_ingredient,distance=..0.04,tag=!temporary_tag] positioned ~ ~ ~ run tp @s ~ ~-0.03 ~
# Lastly, secondary ingredients
execute as @s[tag=!primary_ingredient,tag=final_position] at @s positioned ~-0.3125 ~0.77 ~-0.375 unless entity @e[type=marker,tag=prep_display,distance=..0.04] positioned ~0.3125 ~-0.77 ~0.375 unless entity @e[type=armor_stand,tag=prep_slot,distance=..0.04,tag=!temporary_tag] positioned ~ ~ ~ run tp @s ~ ~-0.03 ~
