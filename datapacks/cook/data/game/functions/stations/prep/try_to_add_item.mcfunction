...
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 39 unless entity @e[type=marker,tag=recipe_ingredient,tag=cone] run summon marker 0 0 0 {Tags:["recipe_ingredient","die_between_games","cone"],CustomName:'["",{"translate":"Waffle Cone"}]'}
...
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 44 unless entity @e[type=marker,tag=recipe_ingredient,tag=cookies] run summon marker 0 0 0 {Tags:["recipe_ingredient","die_between_games","cookies"],CustomName:'["",{"translate":"Cookies \'n Cream"}]'}
...
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 1 as @e[type=marker,tag=recipe_ingredient,tag=hamburger_bun] if data storage current_order_1 Recipe{Ingredients:["Hamburger Bun"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 2 as @e[type=marker,tag=recipe_ingredient,tag=cheese] if data storage current_order_1 Recipe{Ingredients:["Cheese"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 3 as @e[type=marker,tag=recipe_ingredient,tag=lettuce_head] if data storage current_order_1 Recipe{Ingredients:["Lettuce Head"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 4 as @e[type=marker,tag=recipe_ingredient,tag=lettuce_leaf] if data storage current_order_1 Recipe{Ingredients:["Lettuce Leaf"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 5 as @e[type=marker,tag=recipe_ingredient,tag=tomato] if data storage current_order_1 Recipe{Ingredients:["Tomato"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 6 as @e[type=marker,tag=recipe_ingredient,tag=tomato_slice] if data storage current_order_1 Recipe{Ingredients:["Tomato Slice"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 7 as @e[type=marker,tag=recipe_ingredient,tag=raw_hamburger] if data storage current_order_1 Recipe{Ingredients:["Raw Hamburger"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 8 as @e[type=marker,tag=recipe_ingredient,tag=half_cooked_hamburger] if data storage current_order_1 Recipe{Ingredients:["Half-Cooked Hamburger"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 9 as @e[type=marker,tag=recipe_ingredient,tag=hamburger] if data storage current_order_1 Recipe{Ingredients:["Hamburger"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 10 as @e[type=marker,tag=recipe_ingredient,tag=burnt_hamburger] if data storage current_order_1 Recipe{Ingredients:["Burnt Hamburger"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 11 as @e[type=marker,tag=recipe_ingredient,tag=scorched_food] if data storage current_order_1 Recipe{Ingredients:["Scorched Food"]} run team join recipe_filled @s

execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 12 as @e[type=marker,tag=recipe_ingredient,tag=rice] if data storage current_order_1 Recipe{Ingredients:["Sushi Rice"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 13 as @e[type=marker,tag=recipe_ingredient,tag=salmon] if data storage current_order_1 Recipe{Ingredients:["Fresh Salmon"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 14 as @e[type=marker,tag=recipe_ingredient,tag=pufferfish] if data storage current_order_1 Recipe{Ingredients:["Fresh Pufferfish"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 15 as @e[type=marker,tag=recipe_ingredient,tag=cut_salmon] if data storage current_order_1 Recipe{Ingredients:["Cut Salmon"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 16 as @e[type=marker,tag=recipe_ingredient,tag=cut_pufferfish] if data storage current_order_1 Recipe{Ingredients:["Cut Pufferfish"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 17 as @e[type=marker,tag=recipe_ingredient,tag=poison_pufferfish] if data storage current_order_1 Recipe{Ingredients:["Poisonous Pufferfish"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 18 as @e[type=marker,tag=recipe_ingredient,tag=avocado] if data storage current_order_1 Recipe{Ingredients:["Avocado"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 19 as @e[type=marker,tag=recipe_ingredient,tag=avocado_slice] if data storage current_order_1 Recipe{Ingredients:["Avocado Slice"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 20 as @e[type=marker,tag=recipe_ingredient,tag=wasabi] if data storage current_order_1 Recipe{Ingredients:["Wasabi"]} run team join recipe_filled @s

execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 21 as @e[type=marker,tag=recipe_ingredient,tag=dough] if data storage current_order_1 Recipe{Ingredients:["Pizza Dough"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 22 as @e[type=marker,tag=recipe_ingredient,tag=sauce] if data storage current_order_1 Recipe{Ingredients:["Tomato Sauce"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 23 as @e[type=marker,tag=recipe_ingredient,tag=pizza_cheese] if data storage current_order_1 Recipe{Ingredients:["Pizza Cheese"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 24 as @e[type=marker,tag=recipe_ingredient,tag=pepperoni] if data storage current_order_1 Recipe{Ingredients:["Pepperoni"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 25 as @e[type=marker,tag=recipe_ingredient,tag=mushroom] if data storage current_order_1 Recipe{Ingredients:["Mushroom"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 26 as @e[type=marker,tag=recipe_ingredient,tag=pineapple] if data storage current_order_1 Recipe{Ingredients:["Pineapple"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 27 as @e[type=marker,tag=recipe_ingredient,tag=thick_crust] if data storage current_order_1 Recipe{Ingredients:["Deep-Dish Crust"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 28 as @e[type=marker,tag=recipe_ingredient,tag=thin_crust] if data storage current_order_1 Recipe{Ingredients:["Thin Crust"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 29 as @e[type=marker,tag=recipe_ingredient,tag=cut_mushroom] if data storage current_order_1 Recipe{Ingredients:["Mushroom Slices"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 30 as @e[type=marker,tag=recipe_ingredient,tag=cut_pineapple] if data storage current_order_1 Recipe{Ingredients:["Pineapple Chunks"]} run team join recipe_filled @s

execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 31 as @e[type=marker,tag=recipe_ingredient,tag=tortilla] if data storage current_order_1 Recipe{Ingredients:["Tortilla"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 32 as @e[type=marker,tag=recipe_ingredient,tag=raw_beef] if data storage current_order_1 Recipe{Ingredients:["Raw Ground Beef"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 33 as @e[type=marker,tag=recipe_ingredient,tag=taco_cheese] if data storage current_order_1 Recipe{Ingredients:["Taco Cheese"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 34 as @e[type=marker,tag=recipe_ingredient,tag=guac] if data storage current_order_1 Recipe{Ingredients:["Guacamole"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 35 as @e[type=marker,tag=recipe_ingredient,tag=salsa] if data storage current_order_1 Recipe{Ingredients:["Salsa"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 36 as @e[type=marker,tag=recipe_ingredient,tag=sour_cream] if data storage current_order_1 Recipe{Ingredients:["Sour Cream"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 37 as @e[type=marker,tag=recipe_ingredient,tag=beef] if data storage current_order_1 Recipe{Ingredients:["Ground Beef"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 38 as @e[type=marker,tag=recipe_ingredient,tag=lettuce_shreds] if data storage current_order_1 Recipe{Ingredients:["Shredded Lettuce"]} run team join recipe_filled @s

execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 39 as @e[type=marker,tag=recipe_ingredient,tag=cone] if data storage current_order_1 Recipe{Ingredients:["cone"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 40 as @e[type=marker,tag=recipe_ingredient,tag=bowl] if data storage current_order_1 Recipe{Ingredients:["bowl"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 41 as @e[type=marker,tag=recipe_ingredient,tag=vanilla] if data storage current_order_1 Recipe{Ingredients:["vanilla"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 42 as @e[type=marker,tag=recipe_ingredient,tag=chocolate] if data storage current_order_1 Recipe{Ingredients:["chocolate"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 43 as @e[type=marker,tag=recipe_ingredient,tag=strawberry] if data storage current_order_1 Recipe{Ingredients:["strawberry"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 44 as @e[type=marker,tag=recipe_ingredient,tag=cookies] if data storage current_order_1 Recipe{Ingredients:["cookies"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 45 as @e[type=marker,tag=recipe_ingredient,tag=mint] if data storage current_order_1 Recipe{Ingredients:["mint"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 46 as @e[type=marker,tag=recipe_ingredient,tag=mango] if data storage current_order_1 Recipe{Ingredients:["mango"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 47 as @e[type=marker,tag=recipe_ingredient,tag=sprinkles] if data storage current_order_1 Recipe{Ingredients:["sprinkles"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 48 as @e[type=marker,tag=recipe_ingredient,tag=chips] if data storage current_order_1 Recipe{Ingredients:["chips"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 49 as @e[type=marker,tag=recipe_ingredient,tag=cherry] if data storage current_order_1 Recipe{Ingredients:["cherry"]} run team join recipe_filled @s
execute if score $mode settings matches 0 if score @s[tag=!temporary_place_tag] ingredient matches 50 as @e[type=marker,tag=recipe_ingredient,tag=cookie_dough] if data storage current_order_1 Recipe{Ingredients:["cookie_dough"]} run team join recipe_filled @s
