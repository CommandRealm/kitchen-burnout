...
execute if data entity @e[type=armor_stand,sort=nearest,limit=1,tag=stovetop_item] HandItems[0].id unless score @s ingredient matches 0 run function game:stations/stovetop/invalid_action
