...
# Burn items that shouldn't be cooked
execute as @e[type=armor_stand,tag=stovetop_item,sort=nearest,limit=1] at @s if score @s ingredient matches 1..6 run scoreboard players set @s ingredient 11
execute as @e[type=armor_stand,tag=stovetop_item,sort=nearest,limit=1] at @s if score @s ingredient matches 21..31 run scoreboard players set @s ingredient 11
execute as @e[type=armor_stand,tag=stovetop_item,sort=nearest,limit=1] at @s if score @s ingredient matches 33.. run scoreboard players set @s ingredient 11
