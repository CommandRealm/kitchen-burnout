...
execute if entity @e[type=armor_stand,tag=prep_slot,distance=..100] as @e[type=marker,tag=prep_display,tag=check_to_serve,distance=..100,sort=nearest,limit=1,scores={prep_display=0}] at @s run function game:serve/check/main
