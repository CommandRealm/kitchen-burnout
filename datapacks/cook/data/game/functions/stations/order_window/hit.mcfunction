...
execute if entity @e[type=area_effect_cloud,distance=..1,tag=raycast_target,limit=1,sort=nearest,tag=order_window,tag=!full_window] run function game:stations/cutting_board/no_cut
