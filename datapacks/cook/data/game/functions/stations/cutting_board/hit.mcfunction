...
execute if entity @e[type=marker,distance=..1,tag=raycast_target,limit=1,sort=nearest,tag=cutting_board,tag=!cut_in_progress] run function game:stations/cutting_board/no_cut
