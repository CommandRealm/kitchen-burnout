...
# Changing the item
execute if score @e[type=armor_stand,tag=cutting_board_item,sort=nearest,limit=1] ingredient matches 3 run loot replace entity @e[type=armor_stand,tag=cutting_board_item,sort=nearest,limit=1] weapon.mainhand loot game:food/burgers/lettuce_leaf
