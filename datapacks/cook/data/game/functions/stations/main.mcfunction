...
execute as @e[type=marker,tag=salmon_spawner,scores={station=1..},sort=random] at @s run function game:stations/salmon_spawner/main
execute as @e[type=marker,tag=pufferfish_spawner,scores={station=1..},sort=random] at @s run function game:stations/pufferfish_spawner/main
