...
execute if score $mode settings matches 2 unless score $no_contest state matches 1 if score $winner shuffle matches 2 run playsound entity.firework_rocket.twinkle master @a[gamemode=adventure,tag=playing,tag=!tutorial,tag=team_2] -11.0 68 46.0 1000 1
...
# Competitive
execute if score $mode settings matches 3 run tellraw @a ["",{"translate":"Kitchen: ","color":"aqua"},{"nbt":"text","color":"blue","entity":"@e[type=text_display,tag=map_name,sort=nearest,limit=1]","interpret":true}]
execute if score $mode settings matches 3 unless score $no_contest state matches 1 if score $timer game_seconds matches 10.. if score $decaseconds game_ticks matches 10.. run tellraw @a ["",{"translate":"%s's Competitive Time: %s","color":"green","with":[{"selector":"@a[gamemode=adventure,tag=playing,tag=!tutorial,limit=1,sort=random]","color":"green"},[{"score":{"objective":"game_minutes","name":"$timer"},"color":"red","bold":true},{"text":":","color":"red","bold":true},{"score":{"objective":"game_seconds","name":"$timer"},"color":"red","bold":true},{"text":".","color":"red","bold":true},{"score":{"objective":"game_ticks","name":"$decaseconds"},"color":"red","bold":true}]]}]
execute if score $mode settings matches 3 unless score $no_contest state matches 1 if score $timer game_seconds matches 10.. if score $decaseconds game_ticks matches ..9 run tellraw @a ["",{"translate":"%s's Competitive Time: %s","color":"green","with":[{"selector":"@a[gamemode=adventure,tag=playing,tag=!tutorial,limit=1,sort=random]","color":"green"},[{"score":{"objective":"game_minutes","name":"$timer"},"color":"red","bold":true},{"text":":","color":"red","bold":true},{"score":{"objective":"game_seconds","name":"$timer"},"color":"red","bold":true},{"text":".0","color":"red","bold":true},{"score":{"objective":"game_ticks","name":"$decaseconds"},"color":"red","bold":true}]]}]
execute if score $mode settings matches 3 unless score $no_contest state matches 1 if score $timer game_seconds matches ..9 if score $decaseconds game_ticks matches 10.. run tellraw @a ["",{"translate":"%s's Competitive Time: %s","color":"green","with":[{"selector":"@a[gamemode=adventure,tag=playing,tag=!tutorial,limit=1,sort=random]","color":"green"},[{"score":{"objective":"game_minutes","name":"$timer"},"color":"red","bold":true},{"text":":0","color":"red","bold":true},{"score":{"objective":"game_seconds","name":"$timer"},"color":"red","bold":true},{"text":".","color":"red","bold":true},{"score":{"objective":"game_ticks","name":"$decaseconds"},"color":"red","bold":true}]]}]
execute if score $mode settings matches 3 unless score $no_contest state matches 1 if score $timer game_seconds matches ..9 if score $decaseconds game_ticks matches ..9 run tellraw @a ["",{"translate":"%s's Competitive Time: %s","color":"green","with":[{"selector":"@a[gamemode=adventure,tag=playing,tag=!tutorial,limit=1,sort=random]","color":"green"},[{"score":{"objective":"game_minutes","name":"$timer"},"color":"red","bold":true},{"text":":0","color":"red","bold":true},{"score":{"objective":"game_seconds","name":"$timer"},"color":"red","bold":true},{"text":".0","color":"red","bold":true},{"score":{"objective":"game_ticks","name":"$decaseconds"},"color":"red","bold":true}]]}]
...
execute if score $mode settings matches 1 unless score $no_contest state matches 1 if score $score game > $score_2 game as @a[tag=playing,tag=!tutorial,tag=team_2,tag=!all_cosmetics] at @s run function lobby:cosmetics/give_20
execute if score $mode settings matches 1 unless score $no_contest state matches 1 if score $score game < $score_2 game as @a[tag=playing,tag=!tutorial,tag=team_2,tag=!all_cosmetics] at @s run function lobby:cosmetics/give_60
execute if score $mode settings matches 1 unless score $no_contest state matches 1 if score $score game < $score_2 game as @a[tag=playing,tag=!tutorial,tag=!team_2,tag=!all_cosmetics] at @s run function lobby:cosmetics/give_20
