...
execute unless score $no_contest game matches 1 run tellraw @a[tag=playing] ["",{"text":"- ","color":"gray"},{"translate":"Game over!","color":"green","bold":true}]
execute if score $no_contest game matches 1 run tellraw @a[tag=playing] ["",{"text":"- ","color":"gray"},{"translate":"NO CONTEST","color":"gray","bold":true}]

execute if score $mode settings matches 1 unless score $no_contest game matches 1 if score $score game > $score_2 game run tellraw @a ["",{"text":"+ ","color":"gray"},{"translate":"The Doers","color":"aqua","bold":true},{"translate":" won!","color":"gold"}]
execute if score $mode settings matches 1 unless score $no_contest game matches 1 if score $score game < $score_2 game run tellraw @a ["",{"text":"+ ","color":"gray"},{"translate":"The Diners","color":"light_purple","bold":true},{"translate":" won!","color":"gold"}]
...
execute if score $mode settings matches 0 unless score $no_contest game matches 1 run tellraw @a[tag=playing] ["",{"text":"- ","color":"gray"},{"translate":"Score: ","color":"green"},{"score":{"objective":"game","name":"$score"},"color":"gold","bold":true}]
execute if score $mode settings matches 0 unless score $no_contest game matches 1 run tellraw @a[tag=playing] ["",{"text":"- ","color":"gray"},{"translate":"Completed Recipes: ","color":"green"},{"score":{"objective":"game","name":"$finished_recipes"},"color":"gold","bold":true}]

execute if score $mode settings matches 1 unless score $no_contest game matches 1 run tellraw @a[tag=playing,tag=!team_2] ["",{"text":"- ","color":"gray"},{"translate":"Score: ","color":"green"},{"score":{"objective":"game","name":"$score"},"color":"gold","bold":true}]
execute if score $mode settings matches 1 unless score $no_contest game matches 1 run tellraw @a[tag=playing,tag=!team_2] ["",{"text":"- ","color":"gray"},{"translate":"Completed Recipes: ","color":"green"},{"score":{"objective":"game","name":"$finished_recipes_1"},"color":"gold","bold":true}]
execute if score $mode settings matches 1 unless score $no_contest game matches 1 run tellraw @a[tag=playing,tag=team_2] ["",{"text":"- ","color":"gray"},{"translate":"Score: ","color":"green"},{"score":{"objective":"game","name":"$score_2"},"color":"gold","bold":true}]
execute if score $mode settings matches 1 unless score $no_contest game matches 1 run tellraw @a[tag=playing,tag=team_2] ["",{"text":"- ","color":"gray"},{"translate":"Completed Recipes: ","color":"green"},{"score":{"objective":"game","name":"$finished_recipes_2"},"color":"gold","bold":true}]

execute if score $mode settings matches 2 unless score $no_contest game matches 1 if score $winner shuffle matches 1 run tellraw @a ["",{"text":"+ ","color":"gray"},{"translate":"The Doers","color":"aqua","bold":true},{"translate":" won!","color":"gold"}]
execute if score $mode settings matches 2 unless score $no_contest game matches 1 if score $winner shuffle matches 2 run tellraw @a ["",{"text":"+ ","color":"gray"},{"translate":"The Diners","color":"light_purple","bold":true},{"translate":" won!","color":"gold"}]
execute if score $mode settings matches 2 unless score $no_contest game matches 1 run tellraw @a ["",{"text":"- ","color":"gray"},{"translate":"Time: ","color":"green"},{"score":{"objective":"game_minutes","name":"$timer"},"color":"gold","bold":true},{"text":":","color":"gold","bold":true},{"score":{"objective":"game_seconds","name":"$timer"},"color":"gold","bold":true}]
