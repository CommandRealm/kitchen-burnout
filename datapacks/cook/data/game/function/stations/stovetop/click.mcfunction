...
execute unless data entity @s data.ingredient run return run function game:stations/stovetop/place_ingredient
...
execute if score $holding_ingredient station matches 0 run function game:inventory/clear_ingredient {slot:"container.0"}
