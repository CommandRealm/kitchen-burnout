...
execute align xyz run summon interaction ~0.5 ~ ~0.5 {Tags:["cutting_board","station","die_between_games","interactable"],width:1.001f,height:0.1f,response:true}
...
# Get a unique id
execute align xyz as @n[type=interaction,tag=cutting_board,distance=..0.5] store result score @s cutting_id run scoreboard players add $new cutting_id 1