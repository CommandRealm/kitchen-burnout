...
execute align xyz run summon item_display ~0.5 ~0.0625 ~0.5 {Tags:["cutting_board","die_between_games"],Rotation:[0f, 90f],item_display:"fixed",Glowing:1b,brightness:{sky:15,block:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],scale:[0.65f,0.65f,0.65f],translation:[0f,0f,0f]}}
# Icon
