...
$data modify storage game:stations/cut text.completed set string entity @s data.inputs 0 $(completed)
$data modify storage game:stations/cut text.remaining set string entity @s data.inputs $(completed) $(length)
data modify storage game:stations/cut text.current set string storage game:stations/cut text.remaining 0 1
$data modify storage game:stations/cut text.remaining set string entity @s data.inputs $(completed_plus_1) $(length)

# Store the current input in the cutting board
data modify entity @s data.current_input set from storage game:stations/cut text.current
