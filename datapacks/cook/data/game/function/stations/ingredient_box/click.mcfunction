...
data modify storage game:ingredient_box id set from entity @n[type=item_display,tag=ingredient_box,distance=..2] item.components."minecraft:custom_data".ingredient
