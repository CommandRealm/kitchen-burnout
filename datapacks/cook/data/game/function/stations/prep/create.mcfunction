...
execute align xyz positioned ~0.5 ~ ~0.5 run kill @e[tag=prep,distance=..5]
...
# Default values for the state distance thresholds
scoreboard players set $expanded prep_distance_threshold 10
scoreboard players set $default prep_distance_threshold 5