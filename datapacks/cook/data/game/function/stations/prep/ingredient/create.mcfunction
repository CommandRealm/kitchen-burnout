...
summon item_display ~ ~0.05 ~ {Tags:["prep","prep_ingredient","die_between_games","needs_ingredient"],teleport_duration:2,transformation:{left_rotation:[1f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],scale:[0.75f,0.75f,1.0f],translation:[0f,0f,0f]}}
