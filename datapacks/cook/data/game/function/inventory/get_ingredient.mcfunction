...
# Get the actual item
$item replace entity @s $(slot) with ender_eye[hide_tooltip={},hide_additional_tooltip={},item_name='{"translate":"ingredient.$(id).name"}',item_model="game:ingredient/$(id)",custom_data={ingredient:$(id)}]
