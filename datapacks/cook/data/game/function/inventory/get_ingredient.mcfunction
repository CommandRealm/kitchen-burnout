...
# Get the actual item
$item replace entity $(entity) $(slot) with ender_eye[tooltip_display={hide_tooltip:true},item_name={"translate":"ingredient.$(id).name"},item_model="kitchen_burnout:ingredients/$(id)",custom_data={ingredient:$(id)}]
