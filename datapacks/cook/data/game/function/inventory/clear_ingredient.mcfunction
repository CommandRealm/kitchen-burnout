...
#$item replace entity @s[type=player] $(slot) with ender_eye[tooltip_display={hide_tooltip:true},item_name="",item_model="minecraft:gray_stained_glass_pane"]
execute as @s[type=player] run function tools:storage/set_for_player {path:"game:inventory/ingredient",value:""}
