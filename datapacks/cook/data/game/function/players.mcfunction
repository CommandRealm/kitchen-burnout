...
execute anchored eyes positioned ^ ^ ^1.75 if entity @n[type=interaction,tag=prep,distance=..0.75] run tag @n[type=interaction,tag=prep_base,distance=..20] add someone_is_looking