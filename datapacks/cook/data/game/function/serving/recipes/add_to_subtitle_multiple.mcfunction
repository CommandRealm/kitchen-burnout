...
execute store result storage game:serving/name count int 1 run scoreboard players get $count recipe
execute if data storage game:serving/name {count:0} run data modify storage game:serving/name count set value 1
