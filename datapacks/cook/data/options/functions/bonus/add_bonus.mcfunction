...
execute if score $bonus settings matches 0 run setblock -6 66 43 oak_wall_sign[facing=north]{Text1:'{"text":"","color":"gray","bold":false,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"translate":"Time Bonus:","color":"gray","bold":false}',Text3:'{"translate":"Off","color":"red"}',Text4:'{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:bonus/click_bonus"}}'}
execute if score $bonus settings matches 1 run setblock -6 66 43 oak_wall_sign[facing=north]{Text1:'{"text":"","color":"gray","bold":false,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"translate":"Time Bonus:","color":"gray","bold":false}',Text3:'{"translate":"On","color":"green"}',Text4:'{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:bonus/click_bonus"}}'}
