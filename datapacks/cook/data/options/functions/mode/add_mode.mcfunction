...
execute if score $display_mode settings matches 0 run setblock 5 66 44 oak_wall_sign[facing=north]{Text1:'{"text":"","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'[" ",{"translate":"Mode: ","color":"gray","bold":false}]',Text3:'{"translate":"Classic","color":"gold"}',Text4:'{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:mode/click_mode"}}'}
execute if score $display_mode settings matches 1 run setblock 5 66 44 oak_wall_sign[facing=north]{Text1:'{"text":"","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'[" ",{"translate":"Mode: ","color":"gray","bold":false}]',Text3:'{"translate":"Competitive","color":"gold"}',Text4:'{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:mode/click_mode"}}'}
execute if score $display_mode settings matches 2 run setblock 5 66 44 oak_wall_sign[facing=north]{Text1:'{"text":"","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'[" ",{"translate":"Mode: ","color":"gray","bold":false}]',Text3:'{"translate":"Versus","color":"gold"}',Text4:'{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:mode/click_mode"}}'}
execute if score $display_mode settings matches 3 run setblock 5 66 44 oak_wall_sign[facing=north]{Text1:'{"text":"","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'[" ",{"translate":"Mode: ","color":"gray","bold":false}]',Text3:'{"translate":"Shuffle","color":"gold"}',Text4:'{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:mode/click_mode"}}'}
