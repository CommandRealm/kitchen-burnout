...
execute if score $glowing settings matches 0 run setblock 7 66 43 oak_wall_sign[facing=north]{Text1:'{"translate":"Glowing","color":"gray","bold":false,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"translate":"Ingredients:","color":"gray","bold":false}',Text3:'{"translate":"Off","color":"red"}',Text4:'{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:glowing/click_glowing"}}'}
execute if score $glowing settings matches 1 run setblock 7 66 43 oak_wall_sign[facing=north]{Text1:'{"translate":"Glowing","color":"gray","bold":false,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"translate":"Ingredients:","color":"gray","bold":false}',Text3:'["",{"translate":"On","color":"green"},{"translate":" (Suggested)","color":"gray"}]',Text4:'{"text":"<<<         >>>","color":"#d4d4d4","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:glowing/click_glowing"}}'}
