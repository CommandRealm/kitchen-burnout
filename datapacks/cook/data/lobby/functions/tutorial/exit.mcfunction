...
execute unless entity @a[gamemode=adventure,tag=tutorial,tag=playing] as @e[type=#game:ingredient_box_outline,tag=ingredient_box_outline,tag=tutorial] run data merge entity @s {Glowing:0b}
