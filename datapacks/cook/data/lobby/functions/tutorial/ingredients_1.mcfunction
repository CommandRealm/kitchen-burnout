...
tellraw @a[distance=..500,tag=tutorial] [{"text":"-","color":"white"},{"text":"=","color":"gray"},{"text":"-","color":"white"},{"text":" ✯","color":"gold"},{"translate":" INGREDIENTS ","color":"green"},{"text":"✯ ","color":"gold"},{"text":"-","color":"white"},{"text":"=","color":"gray"},{"text":"-","color":"white"},{"text":"\n"},{"selector":"@e[type=marker,tag=recipe_ingredient,tag=tutorial]","color":"yellow"}]
