...
execute if score $ready_players pregame matches 1.. unless score $mode settings matches 1..2 unless score $countdown pregame matches 0.. unless entity @a[tag=temporary_tag] run function lobby:pregame/start_countdown
execute unless score $ready_players pregame matches 1.. run function lobby:pregame/not_enough_players
