...
execute as @a[x=0,y=66,z=0,distance=..500,gamemode=adventure,tag=!tutorial] at @s unless entity @s[nbt={Inventory:[{Slot:4b,id:"minecraft:knowledge_book"}]}] run function lobby:spectating/get_book
execute as @a[x=0,y=66,z=0,distance=..500,gamemode=adventure,tag=tutorial] at @s unless entity @s[nbt={Inventory:[{Slot:6b,id:"minecraft:knowledge_book"}]}] run function lobby:spectating/get_book
