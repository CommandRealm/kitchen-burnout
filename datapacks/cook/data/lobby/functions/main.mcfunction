...
execute if entity @a[gamemode=adventure,x=4,y=65,z=-7,dx=18,dy=5,dz=8,tag=tutorial,tag=!playing] as @e[type=magma_cube,tag=ingredient_box_outline,tag=tutorial] run data merge entity @s {Glowing:1b}
