...
# Hats
execute as @a[gamemode=adventure,tag=!playing,x=0,y=66,z=0,distance=..500,scores={hat=1..9}] at @s unless entity @s[nbt={Inventory:[{Slot:101b,id:"minecraft:stone_button"}]}] run function game:inventory/hat/chef
