...
item replace entity @s enderchest.16 with gold_nugget{Enchantments:[{}],clickable:1,HideFlags:63,display:{Name:'[{"translate":"Advancement Unlocks","color":"gold","bold":true,"italic":false}]'}}
